...
# sort end of wind sfx,at start make stars fade up to maxnumstars fade down to minnumstars, at end fade up to maxnumstars end 130ish with fade down, flicker sun when stoppped, nightsfx fade up and 5s, stars fade up/down vol/bright start and end, rain, distant thunder, cloundsend/forest/nightsfx transistion, more lightnngsfx
DT = 1.0 / 20
SPEED = 1.5
SUN_UP = 15
...
class Pattern(object):
	...
	def init(self):
		...
		self.starssfx = loadsounds('patterns/starssfx/', ['plinks%d' %n for n in range(8)])
